...
doc1 = Nokogiri::XML("<divs type='array' id='a'><div><a>A</a><b>B</b></div><div><a>C</a><b>D</b></div></divs>")
doc2 = Nokogiri::XML("<divs type='array' id='' name='b'><div><b>D</b><a>C</a></div><div><b>B</b><a>A</a></div></divs>")

#doc1 = Nokogiri::XML(IO.read("browse_get_shows.xml"))
#doc2 = Nokogiri::XML(IO.read("browse_get_shows1.xml"))

#Ouput the differences
